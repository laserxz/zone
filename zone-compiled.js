...
function AppCard({
  ...
  return /*#__PURE__*/React.createElement("a", {
    ...
    style: {
      ...
      textDecoration: "none",
      color: "inherit",
      animation: `cardFadeIn 0.4s ease ${index * 0.05}s both`
    }
    ...
    style: {
      ...
      boxShadow: hovered ? `0 12px 40px ${app.color}22, 0 0 30px ${app.color}11, inset 0 1px 0 rgba(255,255,255,0.05)` : "0 2px 16px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.03)",
      cursor: "pointer"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
...
function PayPalDonate() {
  ...
  useEffect(() => {
    ...
    function renderButton() {
      if (paypalRef.current && window.paypal && window.paypal.HostedButtons) {
        ...
        }).render(paypalRef.current).then(() => setLoaded(true));
      }
    }
  }, []);
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Loading PayPal...")), /*#__PURE__*/React.createElement("div", {
    ref: paypalRef,
    style: {
      width: "100%",
      maxWidth: 400
...
function ZoneLanding() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ParticleField, null), /*#__PURE__*/React.createElement(ScanLines, null), /*#__PURE__*/React.createElement("nav", {
    ...
    icon: "\u25C7",
    title: "Free Forever",
    desc: "Every app is completely free. No sign-ups, no paywalls, no premium tiers.",
    color: "#00ff88"
  }, {
    icon: "\u25B3",
    title: "Donationware",
    desc: "50% of all donations go to Kiva \u2014 supporting women-led micro-businesses in the Pacific Islands.",
    color: "#00b4d8"
  }, {
    icon: "\u25CB",
    title: "Built in Australia",
    desc: "Created by Flying Pictures. These tools solve real problems we\u2019ve encountered in our own work.",
    color: "#bf5af2"
  ...
  }, "Kiva.org"), " ", "micro-financing for women-led small businesses in the Pacific Islands."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: "rgba(255,255,255,0.3)",
      marginBottom: 24,
